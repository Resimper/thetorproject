...
Download the latest version of the Tor Browser on [this github page](https://github.com/Resimper/thetorproject/releases/tag/version), from [the website.](https://www.torproject.org/download/), or [download it directly here!](https://github.com/Resimper/thetorproject/releases/download/version/tor-browser-windows-x86_64_13.0.1.exe)
